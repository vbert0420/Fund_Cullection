    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg"> Sign Up for Finance</p>

          <form method="post">
            <div class="input-group mb-3">
              <input type="text" name="name" required class="form-control" placeholder="Finance Full Name">
            ...
            <div class="input-group mb-3" style="display:none">
              ...
              <input type="text" name="client_number" value="iBank-CLIENT-<?php echo $_Number; ?>" class="form-control" placeholder="Finance Number">
              <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="input-group mb-3">
              <input type="text" name="phone" required class="form-control" placeholder="Finance Phone Number">
              <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="input-group mb-3">
              <input type="text" name="address" required class="form-control" placeholder="Finance Address">
              <div class="input-group-append">
                <div class="input-group-text">
            ...
            <div class="input-group mb-3">
              <input type="email" name="email" required class="form-control" placeholder="Finance Email Address">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-envelope"></span>
                </div>
