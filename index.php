...
?>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" target="_blank" href="admin/pages_index.php"> LOGIN ADMIN </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" target="_blank" href="staff/pages_staff_accounting.php"> LOGIN ACCOUNTING  (Staff) </a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" target="_blank" href="client/pages_client_index.php">LOGIN FINANCE  (Client)</a>
                        </li>
                    </ul>
        ...
        <div class="intro py-5 py-lg-9 position-relative text-white">
            <div class="">
                <img src="dist/army.png" class=" img-cover"/>
            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
                            ...
                            <br>
                            <a class="btn btn-success btn-lg mr-lg-2 my-1" target="_blank" href="request_form.php" role="button"> No Account? Request One </a> <BR>
